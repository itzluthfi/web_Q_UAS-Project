...
<nav class="bg-gray-900 border-b border-gray-800 sticky top-0 z-50">
            ...
            <div class="flex items-center">
                ...
                <form action="{{ url('/anime/search') }}" method="GET">
                    <div class="hidden md:block mr-4">
                        <div class="relative">
                            <input type="text" placeholder="Cari anime..." name="q" required class="input-dark w-64 pl-10 pr-4 py-2 rounded-lg text-sm focus:outline-none">
                ...
                @auth
                    ...
                    <div class="hidden md:flex md:items-center">
                        ...
                        <div class="ml-3 relative">
                            <div>
                                <button type="button" class="flex items-center text-sm bg-gray-800 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-purple-500 hover:bg-gray-700 transition" id="user-menu-button">
                ...
                @else
                    ...
                    <div class="hidden md:flex md:items-center">
                        ...
                        <a href="{{ route('register') }}" class="ml-2 bg-purple-700 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-purple-600 transition-colors btn-glow">
                            Sign Up
                        </a>
                    </div>
                @endauth
    ...
    <div class="hidden md:hidden mobile-menu" id="mobile-menu">
        ...
        <form action="{{ url('/anime/search') }}" method="GET" class="px-2 pt-2 pb-3 md:hidden">
            <div class="relative">
                <input type="text" name="q" placeholder="Cari anime..." required class="input-dark w-full pl-10 pr-4 py-2 rounded-lg text-sm focus:outline-none">
                <button type="submit" class="absolute inset-y-0 left-0 pl-3 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
        ...
        @else
            ...
            <div class="pt-4 pb-3 border-t border-gray-700">
                <div class="flex items-center justify-center space-x-4 px-5">
                    <a href="{{ route('login') }}" class="w-1/2 text-center bg-gray-700 text-white px-4 py-2 rounded-md text-base font-medium hover:bg-gray-600 transition-colors">
                        Sign In
                    </a>
                    <a href="{{ route('register') }}" class="w-1/2 text-center bg-purple-700 text-white px-4 py-2 rounded-md text-base font-medium hover:bg-purple-600 transition-colors btn-glow">
                        Sign Up
                    </a>
                </div>
            </div>
