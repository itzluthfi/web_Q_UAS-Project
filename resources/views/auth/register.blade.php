...
@section('content')
    ...
    <div class="flex items-center justify-center p-4">
        <div class="w-full max-w-4xl flex overflow-hidden rounded-xl shadow-2xl bg-gray-800 glow-effect">
            ...
            <div class="hidden md:block w-1/2 relative anime-bg" style="background-image: url('{{ asset('assets/system/gojo2.gif') }}'); background-size: cover; background-position: center;">
                ...
                <form action="{{ route('register.submit') }}" method="POST" class="space-y-5">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" name="email" type="email" required class="input-dark block w-full pl-10 pr-3 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Masukkan email" />
                        </div>
                    </div>
