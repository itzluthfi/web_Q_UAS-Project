...
@section('content')
    ...
    <div class="flex items-center justify-center p-4">
        <div class="w-full max-w-4xl flex overflow-hidden rounded-xl shadow-2xl bg-gray-800 glow-effect">
            ...
            <div class="hidden md:block w-1/2 relative anime-bg" style="background-image: url('{{ asset('assets/system/sjw.png') }}'); background-size: cover; background-position: center;">
