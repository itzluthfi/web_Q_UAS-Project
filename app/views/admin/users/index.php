...
<body class="min-h-screen bg-gradient-to-br from-gray-900 to-black text-gray-100">
    ...
    <aside class="sidebar bg-gray-900 border-r border-gray-800">
        ...
        <nav class="mt-4">
            ...
            <a href="admin-dashboard.php" class="sidebar-link flex items-center px-4 py-3 text-gray-300 hover:text-white">
            ...
            <a href="<?= route('admin.dashboard')?>" class="sidebar-link flex items-center px-4 py-3 text-gray-300 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <table class="admin-table w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs text-gray-300 uppercase tracking-wider">Login Terakhir</th>
                        ...
                        <tbody class="divide-y divide-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><?= $user['last_login'] ?></td>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex space-x-2">
                                <button class="px-3 py-1 rounded bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
                                    </svg>
                                </button>
                                <button class="px-3 py-1 rounded bg-purple-700 text-white">1</button>
                                <button class="px-3 py-1 rounded bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors">2</button>
                                <button class="px-3 py-1 rounded bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors">3</button>
                                <button class="px-3 py-1 rounded bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors">4</button>
                                <button class="px-3 py-1 rounded bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors">5</button>
                                <button class="px-3 py-1 rounded bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <div class="mt-4">
                                <div class="bg-gray-700 rounded-lg p-4 mb-4">
                                    <div class="flex flex-col items-center sm:flex-row sm:items-start">
                                        ...
                                        <div>
                                            <h4 class="text-lg font-medium text-white" id="view-username">naruto_uzumaki</h4>
                ...
                <div class="bg-gray-900 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button" onclick="openEditModal(2)" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm">
                        Edit Pengguna
                    </button>
                    <button type="button" onclick="closeViewModal()" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-600 shadow-sm px-4 py-2 bg-gray-800 text-base font-medium text-gray-300 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        Tutup
                    </button>
                </div>
            </div>
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="bg-gray-900 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button type="button" onclick="closeAddUserModal()" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-600 shadow-sm px-4 py-2 bg-gray-800 text-base font-medium text-gray-300 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        Batal
                    </button>
                </div>
            </div>
