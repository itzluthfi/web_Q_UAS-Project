        ...
        <div class="dashboard-card p-6 mb-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2">
                    <div class="relative">
                        <input type="text" placeholder="Cari komentar..."
                            class="input-dark rounded-md pl-10 pr-4 py-2 w-64">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-3">
                                        <a href="/anime/show/{{ $comment->anime_id }}"
                                            ...
                                            title="Lihat Komentar" aria-label="Lihat Komentar">
                                        ...
                                        <button onclick="openEditModal('{{ $comment->id }}', event)"
                                            class="text-purple-400 hover:text-purple-300 transition-colors duration-150"
                                            title="Edit Komentar" aria-label="Edit Komentar">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                                fill="currentColor">
                                                <path
                                        ...
                                        <button onclick="confirmDelete('{{ $comment->id }}', event)"
                                            ...
                                            title="Hapus Komentar" aria-label="Hapus Komentar">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                                fill="currentColor">
                                                <path fill-rule="evenodd"
                        ...
                        <div class="mt-4 space-y-4">
                            <div>
                                <label for="edit-username"
                                    class="block text-sm font-medium text-gray-300">Pengguna</label>
                                <input type="text" id="edit-username" class="mt-1 input-dark w-full rounded-md"
                                    disabled>
                            </div>
                            <div>
                                <label for="edit-content"
                                    class="block text-sm font-medium text-gray-300">Konten</label>
                                <input type="text" id="edit-content-type"
                                    class="mt-1 input-dark w-full rounded-md" disabled>
                            </div>
                            <div>
                                <label for="edit-comment"
                                    class="block text-sm font-medium text-gray-300">Komentar</label>
