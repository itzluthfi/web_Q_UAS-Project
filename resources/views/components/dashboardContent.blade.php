  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      ...
      <div class="dashboard-card p-6">
          ...
          <div class="mt-6">
              <a href="#"
                  class="block w-full bg-purple-700 hover:bg-purple-600 text-white text-center py-2 px-4 rounded-md btn-glow transition-all">
      ...
      <div class="dashboard-card p-6">
          ...
          <div class="mt-6">
              <a href="#"
                  class="block w-full bg-gray-700 hover:bg-gray-600 text-white text-center py-2 px-4 rounded-md transition-all">
                  <div class="flex items-center justify-center">
          ...
          <table class="admin-table w-full">
              <thead>
                  <tr>
                      ...
                      <th class="px-6 py-3 text-left text-xs text-gray-300 uppercase tracking-wider">Tanggal Daftar
                      </th>
