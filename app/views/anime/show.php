            ...
            <div class="md:flex p-6">
                <div class="md:w-64 flex-shrink-0 mb-6 md:mb-0">
                    ...
                    <div class="mt-4 bg-gray-700 rounded-lg p-3 text-center">
                        <div class="text-3xl font-bold text-yellow-400"><?= htmlspecialchars($anime['score']) ?></div>
                ...
                <div class="md:ml-6 flex-1">
                    <h1 class="text-3xl font-bold text-purple-400 mb-4"><?= htmlspecialchars($anime['title']) ?></h1>
                    ...
                    <div class="flex flex-wrap gap-2 mb-4">
                        ...
                        <span class="bg-gray-700 text-gray-300 px-3 py-1 rounded-full text-sm">
                            <?= htmlspecialchars($anime['episodes']) ?> Episode
                        </span>
                        <span class="bg-gray-700 text-gray-300 px-3 py-1 rounded-full text-sm">
                    ...
                    <div class="mb-4 text-gray-400">
                        <p class="mb-1"><strong class="text-gray-300">Tayang:</strong> <?= htmlspecialchars($anime['aired']['string']) ?></p>
