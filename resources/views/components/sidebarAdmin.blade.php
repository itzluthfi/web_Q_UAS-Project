<aside class="sidebar bg-gray-900 border-r border-gray-800" id="sidebar">
    ...
    <div class="p-4 border-b border-gray-800">
        <div class="flex items-center justify-between">
            ...
            <button class="md:hidden text-gray-400 hover:text-white" id="closeSidebarBtn">
    ...
    <nav class="mt-4">
        ...
        <!-- Dashboard -->
        <a href="{{ route('auth.dashboard') }}" class="sidebar-link flex items-center px-4 py-3 text-gray-300 hover:text-white 
        ...
        <!-- Profil Saya -->
        <a href="{{ route('auth.profile') }}" class="sidebar-link flex items-center px-4 py-3 text-gray-300 hover:text-white 
        ...
        <!-- Pengaturan -->
        <a href="{{ route('auth.setting') }}" class="sidebar-link flex items-center px-4 py-3 text-gray-300 hover:text-white 
        ...
        <!-- Sinkronisasi  -->
        <a href="{{ route('admin.syncAnimePage') }}" class="sidebar-link flex items-center px-4 py-3 text-gray-300 hover:text-white 
           @if (request()->routeIs('admin.syncAnimePage')) active @endif">
        ...
        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
            class="sidebar-link flex items-center px-4 py-3 text-gray-300 hover:text-white hover:bg-red-600 transition-all
          @if (request()->routeIs('logout')) bg-red-600 text-white @endif">
